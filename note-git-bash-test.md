...
Vous avez, également, la commande ```echo "votre texte" >> nom_du_fichier```

> Utiliser ```>>``` pour ajouter (append), évite de supprimer les anciennes données. 😎
...
`push`  dowload vos fichiers du local (le client) vers le dépôt Github.
...
- 23-May-2022/16:35:56.071+2:00JJ V